...
int main(){
	...
	cout << string(7 , '\n'); 
	cout << "\033[1;36m99)About________________________________________100)Update\033[1;m" << endl;
	cout << "\n \nPlease Enter Number:";
	cin >> n;
	if(1 == n){
		string s;
		...
		system("sudo apt-get install python-pycurl python-xmlbuilder python-beautifulsoup python-geoip");
